...
use Training5\VendorRepository\Api\VendorProductRepositoryInterface;
...
class VendorProductRepository implements \Training5\VendorRepository\Api\VendorProductRepositoryInterface
{
    ...
    public function getAssociatedProductsIds($vendor_id)
    {
        $product_ids = [];
        $collection = $this->collectionFactory->create();
